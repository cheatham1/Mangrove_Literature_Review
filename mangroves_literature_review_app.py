...
<header class="hdr">
  ...
  <div class="hdr-meta">
    <span>213 sources reviewed</span><span class="sep">&middot;</span>
...
<div id="p-summary" class="pnl on">
  ...
  <div class="ins">This scoping review synthesised 213 sources spanning 24 years (2002&ndash;2026) across peer-reviewed literature, grey literature, policy documents, and intergovernmental reports. The evidence base has grown rapidly: 55% of all sources were published from 2023 onward, reflecting the emergence of mangrove plastic pollution as a distinct research field.</div>

  <div class="sg">
    <div class="sc" style="border-left-color:#1B7A5A"><div class="v" style="color:#1B7A5A">213</div><div class="l">Sources reviewed</div><div class="s">across 7 thematic areas</div></div>
    <div class="sc" style="border-left-color:#2E5FA1"><div class="v" style="color:#2E5FA1">138</div><div class="l">Peer-reviewed articles</div><div class="s">65% of evidence base</div></div>
    <div class="sc" style="border-left-color:#5C3DAF"><div class="v" style="color:#5C3DAF">79</div><div class="l">High-quality sources</div><div class="s">scored 90&ndash;100%</div></div>
    ...
    <div class="g2">
      ...
      <div class="card">
        ...
        <div style="font-size:12.5px;color:#5E5C56;line-height:1.7;font-weight:300">
          <strong style="font-weight:500">Asia / Middle East</strong> contributes the largest body of primary research (23%), particularly on plastic pollution state and microplastics in sediments &mdash; reflecting Southeast Asian fieldwork concentration.<br><br>
          <strong style="font-weight:500">Global studies</strong> (55%) are mainly policy analyses, intergovernmental reports, and ecosystem reviews &mdash; important for framing but limited in site-specific data.<br><br>
          <strong style="font-weight:500">Africa</strong> (8%) has emerging evidence, mostly from East Africa. West African mangrove systems are notably underrepresented.
        </div>
      </div>
    </div>
  </div>
...
<div id="p-evidence" class="pnl">
  ...
  <div class="sec">
    ...
    <div class="sec-s">Peer-reviewed evidence is strongest in plastic pollution research (83%) and transboundary research (80%), but weakest in policy analysis (22%), which relies heavily on intergovernmental and legal sources.</div>
  ...
  <div class="sec">
    ...
    <div class="card" style="overflow-x:auto">
      ...
      <div style="font-size:12px;color:#908E88;margin-top:14px;font-weight:300">The strongest evidence cluster is mangrove plastic pollution research at the global level (38 sources), followed by Asia/Middle East (25 sources). Transboundary research is almost exclusively global-level. Mitigation evidence is most concentrated in Global and Asia/Middle East sources.</div>
    </div>
  </div>
...
<div id="p-gaps" class="pnl">
  ...
  <div class="sec">
    ...
    <div class="sec-s">Proportion of sources published since 2023. Mitigation research is the most recent (86%); microplastics/POPs and plastic-pollution research have the oldest evidence profiles (46% each).</div>
...
<footer class="footer">Scoping review dashboard &middot; Plastic pollution in mangrove ecosystems &middot; Based on PRISMA-ScR methodology &middot; 213 sources &middot; 2002&ndash;2026</footer>
</div>
...
const litVals=[138,41,10,9,12,3];
...
new Chart(document.getElementById('pieLitType'),{
  ...
  options:{responsive:true,cutout:'52%',plugins:{tooltip:{callbacks:{label:c=>c.label+': '+c.raw+' ('+Math.round(c.raw/213*100)+'%)'}}}}
});
...
new Chart(document.getElementById('pieQuality'),{
  ...
  options:{responsive:true,cutout:'52%',plugins:{tooltip:{callbacks:{label:c=>c.label+': '+c.raw+' ('+Math.round(c.raw/208*100)+'%)'}}}}
});
...
new Chart(document.getElementById('cArea'),{
  ...
  data:{labels:['Plastic pollution\nin mangroves','Policy &\ngovernance','Microplastics,\nadditives & POPs','Ecosystem services\n& linkages','Impact\nassessment','Mitigation &\nclean-up','Transboundary\nriverine pollution'],
    datasets:[{data:[70,32,26,26,30,14,15],backgroundColor:C,borderRadius:4,barThickness:22}]},
...
new Chart(document.getElementById('cYear'),{
  ...
  data:{labels:['\u22642015','2016','2017','2018','2019','2020','2021','2022','2023','2024','2025','2026'],
    datasets:[{data:[25,4,3,8,9,16,12,17,29,31,30,26],backgroundColor:'#1B7A5A',borderRadius:4,barThickness:28}]},
...
// ══════════════ THEMES TAB ══════════════
const themes=[
{area:'State of plastic pollution in mangroves',n:70,pr:83,rec:46,color:'#1B7A5A',bg:'#E1F5EE',top:'Global (38)',
...
{area:'Policy and governance analysis',n:32,pr:22,rec:62,color:'#2E5FA1',bg:'#E6F1FB',top:'Global (18)',
...
{area:'Microplastics, chemical additives & POPs',n:26,pr:77,rec:46,color:'#8B6914',bg:'#F5EDD4',top:'Global (13)',
  sum:'Strongly peer-reviewed evidence base examining bioaccumulation, environmental persistence, and health effects of persistent organic pollutants associated with plastics. European research is notably present (5 sources). Has one of the oldest evidence profiles \u2014 54% published before 2023.',
  kw:['Bioaccumulation','POPs health effects','Environmental persistence','Fisheries contamination','Biomagnification']},
{area:'Ecosystem services and linkages',n:26,pr:46,rec:65,color:'#5C3DAF',bg:'#E4DFF5',top:'Global (14)',
...
{area:'Impact assessment',n:30,pr:73,rec:50,color:'#C05530',bg:'#FAECE7',top:'Global (20)',
...
{area:'Mitigation and clean-up practices',n:14,pr:50,rec:86,color:'#993556',bg:'#FBEAF0',top:'Asia / ME (5)',
  sum:'The smallest but most recent thematic category \u2014 86% published since 2023. Covers clean-up methodologies, bioplastic alternatives, circular economy approaches, and community-based interventions. Limited evidence for effectiveness of specific interventions.',
  kw:['Coastal debris pathways','Integrated governance','Ecosystem services','Coastal livelihoods','Assessment methodology']},
{area:'Transboundary riverine plastic & chemical pollution',n:15,pr:80,rec:53,color:'#3B8BD4',bg:'#E6F1FB',top:'Global (10)',
  sum:'A strongly peer-reviewed evidence base (80%) but almost entirely global-level studies. Examines how rivers transport plastic and chemical pollutants to coastal mangrove systems. Lacks regional case studies \u2014 a critical gap.',
...
new Chart(document.getElementById('cEvType'),{
  ...
  data:{labels:areaShort,datasets:[
    {label:'Peer reviewed',data:[58,7,20,12,22,7,12],backgroundColor:'#2E5FA1',borderRadius:2,barThickness:22},
    {label:'Grey literature',data:[9,5,5,9,6,5,2],backgroundColor:'#8B6914',borderRadius:2,barThickness:22},
    {label:'Policy / intergov.',data:[0,20,0,0,1,0,0],backgroundColor:'#5C3DAF',borderRadius:2,barThickness:22},
    {label:'Conferences / other',data:[3,0,1,5,1,2,1],backgroundColor:'#888780',borderRadius:2,barThickness:22}
  ]},
  options:{indexAxis:'y',responsive:true,maintainAspectRatio:false,
...
// Heatmap
const hd={'Plastic pollution':{Global:38,'Asia / ME':25,Africa:3,Europe:0,Americas:3,Pacific:1},'Policy & governance':{Global:18,'Asia / ME':3,Africa:8,Europe:1,Americas:1,Pacific:1},'Microplastics & POPs':{Global:13,'Asia / ME':6,Africa:1,Europe:5,Americas:0,Pacific:1},'Ecosystem services':{Global:14,'Asia / ME':5,Africa:3,Europe:0,Americas:2,Pacific:1},'Impact assessment':{Global:20,'Asia / ME':3,Africa:0,Europe:1,Americas:2,Pacific:1},'Mitigation':{Global:5,'Asia / ME':5,Africa:2,Europe:1,Americas:1,Pacific:0},'Transboundary':{Global:10,'Asia / ME':1,Africa:1,Europe:1,Americas:0,Pacific:1}};
...
Object.entries(hd).forEach(([a,vs])=>{hh+=`<tr><td>${a}</td>`;regs.forEach(r=>{const v=vs[r]||0;const i=v/38;let bg,tc;if(!v){bg='transparent';tc='#908E88'}else{bg=`rgba(27,122,90,${.12+i*.75})`;tc=i>.45?'#fff':'#1A1A18'}hh+=`<td><span class="hc" style="background:${bg};color:${tc};font-weight:${v>10?500:400}">${v||'\u2013'}</span></td>`});hh+='</tr>'});
hh+='</tbody>';document.getElementById('htable').innerHTML=hh;

// Keywords
const kws=[{k:'Social impacts',v:86},{k:'Assessment methodology',v:69},{k:'Biodiversity',v:62},{k:'Mangrove ecosystem services',v:58},{k:'Coastal debris pathways',v:55},{k:'POPs human health effects',v:47},{k:'Integrated coastal governance',v:45},{k:'Chemicals governance',v:43},{k:'Mangrove debris accumulation',v:42},{k:'Bioaccumulation',v:42},{k:'Land-based plastic leakage',v:40},{k:'Plastic debris / microplastic',v:39},{k:'Multilateral agreements',v:37},{k:'Marine litter governance',v:36}];
const kwG=document.getElementById('kwGrid');
kws.forEach(kw=>{kwG.innerHTML+=`<div class="kw-r"><div class="kw-l">${kw.k}</div><div class="kw-bt"><div class="kw-bf" style="width:${(kw.v/86*100).toFixed(0)}%"></div></div><div class="kw-c">${kw.v}</div></div>`});

// ══════════════ GAPS TAB ══════════════

// Geo gaps
const ggs=[
  {r:'Pacific / Oceania',v:'6',n:'Papua New Guinea, Fiji, and Solomon Islands have extensive mangrove systems but are nearly absent from the evidence base. The 6 Pacific-tagged sources cover deep-sea POPs, Fiji microplastics in fish, and NZ mangrove ecology \u2014 none specifically study plastic pollution within Pacific mangroves.'},
  {r:'Americas',v:'9',n:'Brazil has the second-largest mangrove area globally, yet only 9 sources cover the Americas. Caribbean island states, facing acute waste management challenges, are particularly underrepresented.'},
...
// Theme gaps
const tgs=[
  {t:'Mitigation effectiveness evidence',d:'14 sources describe interventions but few evaluate outcomes. Cost-effectiveness data and longitudinal impact assessments are absent.'},
  {t:'Transboundary corridor case studies',d:'Of 15 transboundary sources, only one primary field study (Niger Delta mangrove sediments) and one grey-literature commentary (Sundarbans / Ganges-Brahmaputra-Meghna) examine specific river-to-mangrove corridors. The Mekong, other major Asian deltas, and most South American river systems remain unstudied.'},
  ...
  {t:'Economic valuation of pollution impacts',d:'Ecosystem services are well documented (26 sources) but economic quantification of damage \u2014 costs to fisheries, tourism, coastal protection \u2014 is largely absent.'},
  {t:'Community and indigenous knowledge',d:'Social impacts are frequently tagged (86 sources) but most measure socioeconomic indicators rather than incorporating local or indigenous perspectives.'},
...
[{a:'Mitigation & clean-up',p:86,c:'#1B7A5A'},{a:'Ecosystem services',p:65,c:'#1B7A5A'},{a:'Policy & governance',p:62,c:'#2E5FA1'},{a:'Transboundary riverine',p:53,c:'#2E5FA1'},{a:'Impact assessment',p:50,c:'#8B6914'},{a:'Plastic pollution in mangroves',p:46,c:'#8B6914'},{a:'Microplastics & POPs',p:46,c:'#C05530'}].forEach(r=>{
